---
title: "Supplementary Material: Analysis of COVID-19 Vaccination Trends Between 2021 and 2023"
format:
  pdf:
    toc: false
...
#| fig-cap: "Table One: Summary Statistics of the Vaccination Data"
#| echo: FALSE
knitr::include_graphics(here("results", "tables", "summary_statistics.png"))
```
Figure one displays the correlatins between all variables within the COVID-19 vaccine dataset. 
```{r}
#| label: Overall Correlation Plot
#| fig-cap: "Figure One: Overall Correlation Plot of COVID-19 Vaccine Data"
#| echo: FALSE
knitr::include_graphics(here("results", "figures", "overall_corrplot.png"))
```

Figure two shows the correlations of specifically the distribution and administration variables in the dataset. The correlation between total_administered and total_distributed is 0.99; the correlation between total_admin_janssen and total_dist_janssen is 0.99; the correlation between total_admin_moderna and total_dist_moderna is 0.99; the correlation between total_admin_pfizer and total_dist_pfizer is 0.99; the correlation between total_admin_novavax and total_dist_novavax is 0.86, which is the lowest of all manufacturers; and the correlation between total_admin_unk and total_dist_unk is 0.03.
```{r}
#| label: Distribution and Administration Correlation Plot
#| fig-cap: "Figure Two: Correlation Plot of Distributed vs. Administrated COVID-19 Vaccine Data"
#| echo: FALSE
knitr::include_graphics(here("results", "figures", "corrplot_dist_admin.png"))
```

Below, you will several scatterplots. Figure three is an overall scatterplot of the relationship between administered and distributed doses. The points closely follow the diagonal line, indicating a strong relationship between the two variables (confirmed by the correlation coeffecient of 0.99). 

```{r}
#| label: Scatterplot of Distributed vs Administered Doses
#| fig-cap: "Figure Three: Scatterplot of Distributed vs Administered Doses "
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin.png"))
```
...
#| fig-cap: "Figure 4.1: Scatterplot of Distributed vs Administered Moderna Doses "
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_moderna.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Janssen Doses 
#| fig-cap: "Figure 4.2: Scatterplot of Distributed vs Administered Janssen Doses "
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_janssen.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Pfizer Doses 
#| fig-cap: "Figure 4.3: Scatterplot of Distributed vs Administered Pfizer Doses "
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_pfizer.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Novavax Doses 
#| fig-cap: "Figure 4.4: Scatterplot of Distributed vs Administered Novavax Doses "
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_novavax.png"))
```
...
#| fig-cap: "Figure 5.1: Scatterplot of Distributed vs Administered Doses in the South"
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_south.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Doses in the Northeast 
#| fig-cap: "Figure 5.2: Scatterplot of Distributed vs Administered Doses in the Northeast"
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_northeast.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Doses in the Midwest
#| fig-cap: "Figure 5.3: Scatterplot of Distributed vs Administered Doses in the Midwest"
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_midwest.png"))
```

```{r}
#| label: Scatterplot of Distributed vs Administered Doses in the West
#| fig-cap: "Figure 5.4: Scatterplot of Distributed vs Administered Doses in the West"
#| echo: FALSE
knitr::include_graphics(here("results","figures","scatterplot_dist_admin_west.png"))
```
...
#| fig-cap: "Table Two: Regional Correlations Between Doses Administered and Distributed"
#| echo: FALSE
resulttable2 = readRDS(here("results","tables","correlation_by_region.rds"))
...
#| fig-cap: "Table Three: Percent Rate Change in Distribution and Administration of COVID-19 Vaccine with time in each Region"
#| echo: FALSE
resulttable3 = readRDS(here("results","tables","region_rate_change.rds"))
...
#| fig-cap: "Table 4.1: Percent Rate Change in Distribution of COVID-19 Vaccine with time for each Manufacturer"
#| echo: FALSE
resulttable4_1 = readRDS(here("results","tables","manuf_dist_rate_change.rds"))
...
#| fig-cap: "Table 4.2: Percent Rate Change in Administration of COVID-19 Vaccine with time for each Manufacturer"
#| echo: FALSE
resulttable4_2 = readRDS(here("results","tables","manuf_admin_rate_change.rds"))
knitr::kable(resulttable4_2)
```

Table 5 shows the RMSE value of the null model (with no predictors) from the modeling analysis.

```{r}
#| label: Null Model RMSE
#| fig-cap: "Table 5: Null Model RMSE"
#| echo: FALSE
resulttable5 = readRDS(here("results", "tables", "null_model.rds"))
