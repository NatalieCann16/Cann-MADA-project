...
knitr::include_graphics("../../results/tables/cumul-covid-table.png")
```
...
#| echo: FALSE
# Display the PNG image using knitr's include_graphics() function
knitr::include_graphics("../../results/figures/covid-combined-plot.png")
```
The table below displays the cumulative counts of flu vaccine doses administered in 2021, 2022, and 2023. 
...
#| echo: FALSE
# Display the PNG image using knitr's include_graphics() function
knitr::include_graphics("../../results/tables/cumul-flu-table.png")
```
...
#| echo: FALSE
# Display the PNG image using knitr's include_graphics() function
knitr::include_graphics("../../results/figures/flu-plot.png")
```
...
#| echo: FALSE
knitr::include_graphics(here("results/tables/covid-manuf-linear-reg.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results/tables/granger-test-table.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results/figures/ccf-manuscript.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results", "tables", "model-comparison-table.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results", "figures", "model-comparison-plot.png"))
```
