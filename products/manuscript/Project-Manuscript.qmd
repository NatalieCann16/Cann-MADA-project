...
I performed a linear regression analysis to assess of doses of vaccines distribution by manufacturer.
...
#| echo: FALSE
knitr::include_graphics(here("results/tables/covid-manuf-reg-table.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results/tables/granger-table-gt.png"))
```
...
#| echo: FALSE
knitr::include_graphics(here("results/figures/ccf.png"))
```
