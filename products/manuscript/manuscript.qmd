...
It is hypothesized that the Northeast region of the U.S. will have the highest uptake of the COVID-19 vaccine due to the area being predominantly liberal. Left-leaning individuals tend to be more trusting of the COVID-19 vaccine [@alemiImpactPoliticalLeaning]. It is believed that Pfizer will have the highest distribution and administration of the vaccine as it received a significant amount of media coverage as compared to other manufacturers [@PfizerDominatesSocial]. Furthermore, it is likely that the distribution and administration of the COVID-19 vaccine peaked around 2022 during the height of the pandemic. Lastly, it is hypothesized that the models will not sufficiently predict the proportion of Pfizer vaccines distributed since synthetic variables were used. 
...
#| echo: FALSE
knitr::include_graphics(here("assets", "workflow-schematic-final.png"))
```
...
Some U.S. regions, such as the South, has a disproportionately higher population than the rest of the major regions. In 2022, the South had 128,716,192 residents [@bureauGrowthUSPopulation]. Therefore, population must be controlled for in this analysis. In order to control for regional population, U.S. Census Bureau data of the four major U.S. region's populations between 2021 and 2023 was used [@UnitedStatesPopulation]. The four major regions are the Midwest, Northeast, South, and West. Note the states included in each region within the map included in the data cleaning section.  
...
In order to categorize the states into their appropriate regions, the CDC's geographic divisions were used [@GeographicDivisionRegion2024]. The graphic below displays these regions. For simplicity, only the Northeast, Midwest, South, and West regions were used in this project. Note the states included in each region within the map below. 
